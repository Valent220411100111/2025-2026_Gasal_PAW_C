    ...
    <div class="container mt-5">
        ...
        <form method="post" class="mt-4">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="nama_barang" name="nama_barang" class="form-control" value="<?php echo $data['nama_barang']; ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="stok" name="stok" class="form-control" value="<?php echo $data['stok']; ?>" required>
            </div>
